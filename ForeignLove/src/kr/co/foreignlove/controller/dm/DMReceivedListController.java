...
import kr.co.foreignlove.service.dm.DMReceivedListService;
import kr.co.foreignlove.vo.DMVO;

public class DMReceivedListController implements BackController {
	
	private DMReceivedListService service;
	
	public DMReceivedListController() {
		service = new DMReceivedListService();
	}
