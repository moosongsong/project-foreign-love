...
<script type="text/javascript" src="../js/memberScript/register.js?var=1.0"></script>
...
<body>
	...
	<div class="container-fluid" style="width: 700px;">
		...
		<div class="container-fluid" id="popup">
			...
			<div class="container-fluid">
				학교찾기<br /> <input type="text" name="m_school" id="schoolTemp"
					class="form-control" placeholder="학교명"
					style="margin: 2px; width: 60%; display: inline;">
				<button type="button" id="check" class="btn"
					style="background-color: #C06C84; color: white; margin: 2px; width: 30%; display: inline;">검색</button>
			</div>
			<div class="container-fluid">
				<div>
		...
		<!-- popdown -->
		<div class="container-fluid" id="popdown" style="width: 400px;">
			<!--main-->
			<div class="container-fluid"
				style="align: center; margin: 30px 0px 20px 0;">
				<img src="../images/logo.png" alt="nopic" style="width: 50px;">
			...
			<div class="container-fluid">
				<div class="container-fluid" style="padding: 0; margin: 0;">
					<input type="text" id="m_email" class="form-control"
						placeholder="이메일"
						style="margin: 2px 0; width: 46%; display: inline;"> @ <select
						class="form-control" id="ori_email"
						style="width: 46%; display: inline;">
						<option value="naver.com">naver.com</option>
						<option value="gmail.com">gmail.com</option>
						<option value="daum.net">daum.net</option>
					</select>
					<button type="button" name="emailCheck" id="emailCheck" class="btn"
						style="background-color: #F67280; color: white; margin: 2px">이메일
						중복확인</button>
				</div>

				<input type="password" name="pass" id="pass" class="form-control"
					placeholder="비밀번호" style="margin: 2px 0;"> <input
					type="password" name="pass2" id="pass2" class="form-control"
					placeholder="비밀번호 확인" style="margin: 2px 0;"> <input
					type="text" id="m_name" class="form-control" placeholder="본명"
					style="margin: 2px 0;"> <input type="text" id="m_phone"
					class="form-control" placeholder="전화번호" style="margin: 2px 0;">

				<input type="text" id="birth" class="form-control"
					placeholder="생년월일"
					style="width: 93%; display: inline; margin: 0; margin-right: 3px">

				<input type="text" id="m_nick" name="m_nick" class="form-control"
					placeholder="별명" style="margin: 2px 0;">
				<button type="button" name="nickCheck" id="nickCheck" class="btn"
					style="background-color: #C06C84; color: white; margin: 2px">닉네임
					중복확인</button>

				<div class="container-fluid" style="margin: 0px; padding: 0px;">
					<input type="text" id="school" class="form-control"
						placeholder="학교" disabled
						style="margin: 2px 0; width: 65%; display: inline;"> <input
						type="hidden" name="m_school" id="m_school">
					<button type="button" name="schoolCheck" id="schoolCheck"
						style="width: 33%; background-color: #6C5B7B; color: white; margin: 2px 0; display: inline;"
						class="btn">학교찾기</button>
				</div>

				<input type="text" id="nation" class="form-control" placeholder="국가"
					style="margin: 2px 0;" disabled> <input type="text"
					id="local" class="form-control" placeholder="세부지역"
					style="margin: 2px 0;" disabled> 성별 <label><input
					type="radio" name="m_sex" value="F" checked
					style="margin-left: 10px; margin-top: 15px"> 여자</label> <label><input
					type="radio" name="m_sex" value="M" style="margin-top: 15px">
					남자</label>

				<div class="container-fluid" style="padding: 0; margin: 0 0 10px 0;">
					<input type="text" id="from" class="form-control" placeholder="교환시작일자"
						style="width: 91%; display: inline; margin: 3px;"> 
					<input type="hidden" id="birthday" class="form-control" size="30">
					<input type="hidden" id="alternateFrom" class="form-control"
						size="30">
				</div>
				<div>
					주소<br /> <input type="hidden" name="zip"
						style="width: 75%; display: inline-block; margin: 0 0 4px 0;"
						class="form-control" /> 주소 : <input type="text" id="addr1"
						name="addr1"
						style="width: 85%; margin: 0 0 7px 0; display: inline-block"
						class="form-control" /><br> 상세 : <input type="text"
						name="addr2"
						style="width: 85%; margin: 0 0 4px 0; display: inline-block"
						class="form-control" /><br>
					<button type="button" class="btn"
						style="background-color: #F67280; color: white; width: 95%"
						onclick="openZipSearch()">한국주소로 입력을 원할 경우 여기를 눌러주세요</button>
					<br>
				</div>
				<div class="">
					<!--  -->
...
본 회원약관은 ForeignLove(이하 '갑'라 한다)이 운영하는 인터넷관련 서비스(이하 '서비스'라 한다)를 이용함에 있어 관리자와 이용자(이하 '회원'라 한다)의 권리, 의무 및 책임사항을 규정함을 목적으로 한다.
...
제 1 조 (시행일) 이 약관은 2020년 05월 16일부터 시행한다.     
							</textarea>
						</div>
						<!-- 2start -->
						<div>
							<input type="checkbox" name="join_user_agree"
								id="join_user_agree"> 본약관에 동의하십니까?
						</div>
					</div>
				</div>
				<!--button-->
				<div class="container">
					<button type="button" name="button" class="btn" id="registerBtn"
						style="width: 150px; margin: 20px 0; background-color: #355C7D; color: white;">회원가입
						신청</button>
				</div>
