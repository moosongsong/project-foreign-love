...
<head>
	...
	<meta http-equiv="X-UA-Compatible" content="IE=Edge" />
  	...
  	<link rel="stylesheet" href="../css/mycss.css">
  	<script src="../js/boardFreeScript/freeBoard.js"></script>
        ...
        <tr style="width:100%;vertical-align: top;">
          ...
          <td style="width:20%;margin-top:0px;padding:0;vertical-align: top;">
            <div class="" style="padding:0;margin:0 10px;">
              ...
              <!--buttons-->
              <div class="">
                <button id="btnNew" type="button" name="button" class="btn" style="width:100%; margin-top:5px; color:white; background-color:#F8B195;" onclick="location.href='freewrite.jsp?IU=insert'">글쓰기</button>
              ...
              <div class="" style="margin-right:2%;width:77%;margin-top:5px;">
                <select id="cond" class="form-control" name="">
